...
<head>
  ...
  <link href="<?= base_url('assets') ?>/assets/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <link href="<?= base_url('assets/sign-in') ?>/signin.css" rel="stylesheet">
</head>
...
<body class="text-center">
  ...
  <main class="form-signin w-100 m-auto">
    ...
    <button class="w-100 btn btn-lg btn-primary" type="submit"><?= lang('Auth.login_submit_btn') ?></button>
